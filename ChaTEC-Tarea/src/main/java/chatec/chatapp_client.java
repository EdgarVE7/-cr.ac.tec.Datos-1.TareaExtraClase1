...
/**
 * The chatapp_client connects to an already iniated server via IP/Port, and displays messages sent/received via socket
 * @author Edgar Vargas
 * @version 1.0
 */
public class chatapp_client extends javax.swing.JFrame {
    /*
    Here we define the variables to be able to connect between server and client
    */
    ...
    /**
     * Creates new form chatapp_client
     */
    ...
    public static void main(String args[]) {
         ...
         * Creates a Socket which connects to a certain IP address and port
